...
export function PrintIdCardModal({ isOpen, onClose, member }: PrintIdCardModalProps) {
    ...
    <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm">
      <div className="relative w-full max-w-lg rounded-2xl bg-white p-6 shadow-2xl">
        ...
        <div className="flex justify-center rounded-xl bg-gray-50 p-8 shadow-inner">
          <div
            ref={printRef}
            className="flex h-[200px] w-[320px] overflow-hidden rounded-xl border border-gray-200 bg-white shadow-lg print:shadow-none print:border-gray-300"
            style={{
          ...
          >
            ...
            <div className="flex w-full flex-col p-4">
              <div className="flex items-start justify-between border-b border-gray-200 pb-2">
                <div>
                  <h4 className="text-[10px] font-bold tracking-widest text-red-800 uppercase">
                    Koperasi Serba Usaha
                  </h4>
                  <h2 className="text-sm font-black text-gray-900">KSU LIDIA</h2>
                </div>
                <div className="rounded-md bg-red-50 px-2 py-0.5">
                  <span className="text-[10px] font-bold text-red-700">ANGGOTA</span>
                </div>
              </div>
              ...
              <div className="mt-3 flex flex-1 items-center gap-4">
                <div className="flex-1 space-y-1.5">
                  <div>
                    <p className="text-[8px] font-semibold text-gray-400 uppercase">
                      Nomor RAT
                    </p>
                ...
                <div className="flex shrink-0 items-center justify-center rounded-lg bg-white p-1.5 shadow-sm border border-gray-100">
                  <QRCode
